...
The sample codes used for clustering the global low-resolution flow field into subdomains (5. Clustering.ipynb), as well as for pretraining the MLP models to estimate the Taylor microscales embedded in the low-resolution inputs (6. MLP.ipynb), are also provided.
